...
class SinglyLinkedList {
  ...
  * [Symbol.iterator]() {
  ...
  // Time: O(n)
  // Space O(1)
  // mergeSortedNodesIterative(l1, l2) {
  //   if (l1 === null) {
  //     return l2;
  //   }
  //   if (l2 === null) {
  ...
  //
  //   if (l1.data < l2.data) {
  //     return this.mergeSortedNodesIterativeImpl(l1, l2);
  //   }
  //
  //   return this.mergeSortedNodesIterativeImpl(l2, l1);
  // }
  //
  // mergeSortedNodesIterativeImpl(l1, l2) {
  //
  // }
